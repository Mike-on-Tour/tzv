...
class mot_tzv_tz_deleted extends \phpbb\notification\type\base
{
	/**
	...
	*/
	...
	{
		return 'mot.tzv.notification.type.notify_tz_deleted';
	}
	...
	*/
	public static $notification_option = [
		'lang'	=> 'UCP_MOT_TZV_NOTIFY_TZ_DELETED',
	...
	*/
	...
	{
		return $this->language->lang('MOT_TZV_NOTIFY_TZ_DELETED', $this->get_data('tz_name'), $this->get_data('display_username'));
	}
	...
	*/
	...
	{
		return '@mot_tzv/mot_tzv_tz_deleted';
	}
