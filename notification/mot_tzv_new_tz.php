...
class mot_tzv_new_tz extends \phpbb\notification\type\base
{
	/**
	...
	*/
	...
	{
		return 'mot.tzv.notification.type.notify_new_tz';
	}
	...
	*/
	public static $notification_option = [
		'lang'	=> 'UCP_MOT_TZV_NOTIFY_NEW_TZ',
	...
	*/
	...
	{
		return $this->language->lang('MOT_TZV_NOTIFY_NEW_TZ', $this->get_data('tz_name'), $this->get_data('display_username'));
	}
