...
class main_module
{
	...
	public function main($id, $mode)
	{
		...
		$acp_controller = $phpbb_container->get('mot.tzv.controller.ucp');

		/** @var \phpbb\language\language $language */
		$language = $phpbb_container->get('language');

		// Load a template from adm/style for our ACP page
		$this->tpl_name = 'ucp_mot_tzv_' . $mode;

		// Set the page title for our ACP page
		$this->page_title = $language->lang('UCP_MOT_TZV_TOURZIEL') . ' - ' . $language->lang('UCP_MOT_TZV_' . utf8_strtoupper($mode));
